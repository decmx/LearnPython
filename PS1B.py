...
#
# Semi-annual raise percentage = semi_annual_raise
#
# Total time = months
#
...
#Ask user to enter semi-annual raise percentage
...
while (current_savings <= down_payment):
    current_savings = ((annual_salary/12*portion_saved)+current_savings) + ((annual_salary/12*portion_saved)+current_savings)*rmonth
    months = months + 1
    if months % 6 == 0:
